...
export const MAPS: MapEntry[] = [
  { id: 'ascent', label: 'Ascent', aliases: ['ascent'] },
  { id: 'bind', label: 'Bind', aliases: ['bind'] },
  { id: 'breeze', label: 'Breeze', aliases: ['breeze'] },
  { id: 'fracture', label: 'Fracture', aliases: ['fracture', 'frac'] },
  { id: 'haven', label: 'Haven', aliases: ['haven'] },
  { id: 'icebox', label: 'Icebox', aliases: ['icebox', 'ice box'] },
  { id: 'lotus', label: 'Lotus', aliases: ['lotus'] },
  { id: 'pearl', label: 'Pearl', aliases: ['pearl'] },
  { id: 'split', label: 'Split', aliases: ['split'] },
  { id: 'sunset', label: 'Sunset', aliases: ['sunset'] },
  { id: 'abyss', label: 'Abyss', aliases: ['abyss'] },
  { id: 'corrode', label: 'Corrode', aliases: ['corrode'] },
];
...
export const AGENTS: AgentEntry[] = [
  // Duelist
  { id: 'jett', label: 'Jett', role: 'duelist', aliases: ['jett'] },
  { id: 'reyna', label: 'Reyna', role: 'duelist', aliases: ['reyna'] },
  { id: 'raze', label: 'Raze', role: 'duelist', aliases: ['raze'] },
  { id: 'phoenix', label: 'Phoenix', role: 'duelist', aliases: ['phoenix'] },
  { id: 'neon', label: 'Neon', role: 'duelist', aliases: ['neon'] },
  { id: 'iso', label: 'Iso', role: 'duelist', aliases: ['iso'] },
  { id: 'waylay', label: 'Waylay', role: 'duelist', aliases: ['waylay'] },
  // Initiator
  { id: 'sova', label: 'Sova', role: 'initiator', aliases: ['sova'] },
  { id: 'breach', label: 'Breach', role: 'initiator', aliases: ['breach'] },
  { id: 'skye', label: 'Skye', role: 'initiator', aliases: ['skye'] },
  { id: 'kayo', label: 'KAY/O', role: 'initiator', aliases: ['kayo', 'kay/o', 'kay o'] },
  { id: 'fade', label: 'Fade', role: 'initiator', aliases: ['fade'] },
  { id: 'gekko', label: 'Gekko', role: 'initiator', aliases: ['gekko'] },
  { id: 'tejo', label: 'Tejo', role: 'initiator', aliases: ['tejo'] },
  // Controller
  { id: 'brimstone', label: 'Brimstone', role: 'controller', aliases: ['brimstone', 'brim'] },
  { id: 'viper', label: 'Viper', role: 'controller', aliases: ['viper'] },
  { id: 'omen', label: 'Omen', role: 'controller', aliases: ['omen'] },
  { id: 'astra', label: 'Astra', role: 'controller', aliases: ['astra'] },
  { id: 'harbor', label: 'Harbor', role: 'controller', aliases: ['harbor'] },
  { id: 'clove', label: 'Clove', role: 'controller', aliases: ['clove'] },
  // Sentinel
  { id: 'sage', label: 'Sage', role: 'sentinel', aliases: ['sage'] },
  { id: 'cypher', label: 'Cypher', role: 'sentinel', aliases: ['cypher'] },
  { id: 'killjoy', label: 'Killjoy', role: 'sentinel', aliases: ['killjoy', 'kj'] },
  { id: 'chamber', label: 'Chamber', role: 'sentinel', aliases: ['chamber'] },
  { id: 'deadlock', label: 'Deadlock', role: 'sentinel', aliases: ['deadlock'] },
  { id: 'vyse', label: 'Vyse', role: 'sentinel', aliases: ['vyse'] },
  { id: 'veto', label: 'Veto', role: 'sentinel', aliases: ['veto'] },
];
