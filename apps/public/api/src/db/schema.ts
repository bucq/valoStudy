...
export type AiTaggingJob = typeof aiTaggingJobs.$inferSelect;
export type NewAiTaggingJob = typeof aiTaggingJobs.$inferInsert;
export type TagCorrectionRequest = typeof tagCorrectionRequests.$inferSelect;
export type NewTagCorrectionRequest = typeof tagCorrectionRequests.$inferInsert;
